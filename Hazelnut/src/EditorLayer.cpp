...
namespace Hazel {
	...
	void EditorLayer::OnImGuiRender()
	{
		...
		if (ImGui::BeginMenuBar())
		{
			if (ImGui::BeginMenu("File"))
			{
				...
				// save and load scenes end  ---------------------------------------------------------------------------------------------> left off on this section and the code was working <----> vid at 16 20 <------------------
	...
	{
		// right now the key binds are only working when the scene window is focused, need to fix this
		// shortcuts - keybinds
