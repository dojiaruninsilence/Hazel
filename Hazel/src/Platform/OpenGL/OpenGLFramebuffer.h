...
namespace Hazel {
	...
	public:
		...
		virtual int ReadPixel(uint32_t attachmentIndex, int x, int y) override;  //  prep fb for mouse pick

		virtual void ClearAttachment(uint32_t attachmentIndex, int value) override; // clear fb tex attach
